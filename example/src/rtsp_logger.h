 ...
 * @LastEditors: lishi
 * @LastEditTime: 2024-08-12 10:09:36
 */
...
public:
    Logger(const char* file, int line, const char* func, LogLevel level = INFO,
        ...
        char buf[100] = {0};
        snprintf(buf, sizeof(buf), "[%04d-%02d-%02d %02d:%02d:%02d.%03d.%03d ",
                 lt->tm_year + 1900, lt->tm_mon + 1, lt->tm_mday, lt->tm_hour,
                 lt->tm_min, lt->tm_sec, (int)(tv.tv_usec / 1000), (int)(tv.tv_usec % 1000));
...
#ifndef RTSP_LOG
#define RTSP_LOG(...) Logger(__FILENAME__, __LINE__, __FUNCTION__, __VA_ARGS__)
#endif

}  // namespace LOG
}  // namespace RTSP

#endif  // RTSP_LOGGER_H_